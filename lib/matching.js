...
// We keep the fuzzy threshold intentionally conservative. A value around 0.22 means we still
// match obvious transcription issues and legal-suffix drift, but we avoid collapsing unrelated firms
// that happen to share a few words. The tradeoff is a small amount of false negatives in exchange for
// fewer wrongly merged accounts, which is safer for an account lead reviewing retainers.

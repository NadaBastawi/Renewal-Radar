...
// We keep the fuzzy threshold intentionally conservative. In the real sample data, the near-miss pairs
// are extremely close under Fuse: Northstar Labs Inc vs North Star Labs Inc scores about 8.6e-12,
// Harbor & Pine Studio vs Harbour and Pine Studio scores about 1.5e-8, and Bright Wave Media vs
// BRIGHTWAVE MEDIA LLC scores about 9.3e-10. That means a threshold around 0.22 still accepts the real
// spelling/casing/legal-suffix variants we expect to match, while staying far enough away from unrelated
// names that share only a couple of words. The tradeoff is a small amount of false negatives in exchange
// for fewer wrongly merged accounts, which is safer for an account lead reviewing retainers.
